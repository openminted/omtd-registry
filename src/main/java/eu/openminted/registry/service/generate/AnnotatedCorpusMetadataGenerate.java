...
public class AnnotatedCorpusMetadataGenerate extends WorkflowOutputMetadataGenerate {
    ...
    public Corpus generateAnnotatedCorpusMetadata(String inputCorpusId, String componentId, String userId,
        ...
        corpus.setCorpusInfo(generateAnnotatedCorpusInfo(workingCorpusOmtdId, inputCorpusId, componentId, userId,
                outputCorpusArchiveId));
        //logger.info("Output corpus metadata::\n " + mapper.writeValueAsString(corpus)+"\n");
        return corpus;
    }


    public CorpusInfo generateAnnotatedCorpusInfo(String corpusOmtdId, String inputCorpusId, String componentId,
                                                  String userId, String outputCorpusArchiveId)
            throws IOException, NullPointerException {
        ...
        corpusInfo.setDatasetDistributionInfo(generateDatasetDistributionInfo(inputCorpus, component,
                outputCorpusArchiveId));
    ...
    private AnnotatedCorpusInfo generateAnnotatedCorpusInfo(Corpus inputCorpus,
                                                            Component component) throws JsonProcessingException {
        ...
        // inputCorpus is annotated corpus
            ...
            AnnotatedCorpusInfo annotatedCorpusInfo = inputCorpus.getCorpusInfo().getCorpusSubtypeSpecificInfo()
                    .getAnnotatedCorpusInfo();
        ...
        if (component.getComponentInfo().getOutputResourceInfo() != null) {
            ...
            List<AnnotationTypeInfo> annotationTypes = component.getComponentInfo().getOutputResourceInfo()
                    .getAnnotationTypes();
            ...
            RelatedResource annotationSchema = component.getComponentInfo().getOutputResourceInfo()
                    .getAnnotationSchema();
            annotationInfo.setAnnotationSchema(annotationSchema);

            // annotationInfo.annotationResource
            RelatedResource annotationResource = component.getComponentInfo().getOutputResourceInfo()
        ...
        isAnnotatedBy.setResourceIdentifiers(component.getComponentInfo().getIdentificationInfo()
