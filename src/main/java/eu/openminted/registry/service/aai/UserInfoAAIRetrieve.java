...
public class UserInfoAAIRetrieve {
    ...
    public int getCoId(String userId) throws IOException {
        ...
        ResponseEntity<String> response = restTemplate.exchange(serviceUri, HttpMethod.GET, request, String.class,
                params);
        //{"ResponseType":"CoPeople","Version":"1.0","CoPeople":[{"Version":"1.0","Id":124,"CoId":2,
        // "Status":"Active","Created":"2017-05-22 11:54:45","Modified":"2017-05-25 10:17:46","Revision":5,
        // "Deleted":false,"ActorIdentifier":"627f00fdf06c18817b27226533b532042db9405395f1c2ec77a3cdab01a1f40d
        // @openminted.eu"}]}
    ...
    public String getEmail(int userCoId) throws IOException {
        ...
        ResponseEntity<String> response = restTemplate.exchange(serviceUri, HttpMethod.GET, request, String.class,
                params);
        //{"ResponseType":"EmailAddresses","Version":"1.0","EmailAddresses":[{"Version":"1.0","Id":147,
        // "Mail":"kgkirtzou@imis.athena-innovation.gr","Type":"official","Verified":false,"Person":{"Type":"CO",
        // "Id":124},"Created":"2017-05-22 11:54:45","Modified":"2017-05-22 11:54:45","Revision":0,"Deleted":false,
        // "ActorIdentifier":"627f00fdf06c18817b27226533b532042db9405395f1c2ec77a3cdab01a1f40d@openminted.eu"}]}
    ...
    public Pair<String, String> getSurnameGivenName(int userCoId) throws IOException {
        ...
        ResponseEntity<String> response = restTemplate.exchange(serviceUri, HttpMethod.GET, request, String.class,
                params);
        // {"ResponseType":"Names","Version":"1.0","Names":[{"Version":"1.0","Id":153,"Given":"Katerina",
        // "Family":"Gkirtzou","Type":"official","Language":"","Person":{"Type":"CO","Id":124},"PrimaryName":true,
        // "Created":"2017-05-22 11:54:45","Modified":"2017-05-22 11:54:45","Revision":0,"Deleted":false,
        // "ActorIdentifier":"627f00fdf06c18817b27226533b532042db9405395f1c2ec77a3cdab01a1f40d@openminted.eu"}]}
