...
public enum ResourceIdentifierSchemeNameEnum {
    ...
    ResourceIdentifierSchemeNameEnum(String v) {
        value = v;
    }
    ...
    public static ResourceIdentifierSchemeNameEnum fromValue(String v) {
        for (ResourceIdentifierSchemeNameEnum c: ResourceIdentifierSchemeNameEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
