...
@XmlType(name = "")
@XmlEnum
public enum ProcessingResourceTypeEnum {
    ...
    ProcessingResourceTypeEnum(String v) {
        value = v;
    }
    ...
    public static ProcessingResourceTypeEnum fromValue(String v) {
        for (ProcessingResourceTypeEnum c: ProcessingResourceTypeEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
