...
public class RepositoryIdentifiers {
    ...
    protected List<RepositoryIdentifier> repositoryIdentifier;
     ...
     * 
     */
    public List<RepositoryIdentifier> getRepositoryIdentifier() {
        if (repositoryIdentifier == null) {
            repositoryIdentifier = new ArrayList<RepositoryIdentifier>();
        }
